---
title: "Example code to visualize LDSC outputs"
author: "Khang Le (Chris)"
date: "10-Sep-2024"
...
#### Manually input desired row name for display
...
#### Creating pvalue and corr matrix with the desired row names
...
corr.matrix %>% head(n=3)                    # Display the matrix to check
...
pval.matrix %>% head(n=3)                    # Display the matrix to check
...
## Step 3: Making correlation plot using ggcorrplot
